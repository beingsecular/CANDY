...
<u><b>ᴘʟᴀʏʟɪsᴛ ᴄᴏᴍᴍᴀɴᴅs :</b></u>
/playlist : ᴄʜᴇᴄᴋ ʏᴏᴜʀ sᴀᴠᴇᴅ ᴘʟᴀʏʟɪsᴛ.
/addplaylist [ᴛʀᴀᴄᴋ/ʟɪɴᴋ] : ᴀᴅᴅ ᴀ ᴛʀᴀᴄᴋ ᴛᴏ ʏᴏᴜʀ sᴀᴠᴇᴅ ᴘʟᴀʏʟɪsᴛ (ᴜᴘ ᴛᴏ 50 ᴛʀᴀᴄᴋs).
/delplaylist [ᴀʟʟ/ɴᴜᴍʙᴇʀ] : ᴅᴇʟᴇᴛᴇ ʏᴏᴜʀ ᴘʟᴀʏʟɪsᴛ ᴏʀ ᴀ sᴘᴇᴄɪғɪᴄ ᴛʀᴀᴄᴋ.
/playplaylist ᴏʀ /vplayplaylist : sᴛʀᴇᴀᴍ ʏᴏᴜʀ ᴡʜᴏʟᴇ sᴀᴠᴇᴅ ᴘʟᴀʏʟɪsᴛ ᴡɪᴛʜ ᴀ sɪɴɢʟᴇ ᴄᴏᴍᴍᴀɴᴅ!

<u><b>ᴀᴜᴛᴏᴘʟᴀʏ :</b></u>
/autoplay [enable/disable] : ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ ᴘʟᴀʏ ʀᴇʟᴀᴛᴇᴅ sᴏɴɢs ᴡʜᴇɴ ǫᴜᴇᴜᴇ ᴇɴᴅs.
"""
